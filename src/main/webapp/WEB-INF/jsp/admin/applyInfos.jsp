                                ...
                                <table class="table" style="margin-bottom: 0;">
                                    ...
                                    <c:forEach items="${applyInfos}" var="applyInfo" varStatus="index">
                                        <tr>
                                            ...
                                            <td>${applyInfo.competitionTitle}</td>
                                            ...
                                            <td>${applyInfo.studentName}</td>
                                            <td>${applyInfo.studentNum}</td>
                                            ...
                                            <td>
                                                <a href="${ctx}/admin/passApplyInfo?id=${applyInfo.id}" class="btn btn-success btn-sm">通过</a>
                                                <a href="${ctx}/admin/deleteApplyInfo?id=${applyInfo.id}" class="btn btn-danger btn-sm">拒绝</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
