...
<div class="container">
    <form action="${ctx}/login/admin" method="post">
        <div class="form-group">
            <label for="exampleInputEmail1">用户名</label>
            <input type="text" class="form-control" name="userName" id="exampleInputEmail1" placeholder="zhangsan">
        </div>
        <div class="form-group">
...
<div style="text-align: center;">
    <span style="margin: auto;"><a href="${ctx}/login/student">学生登录</a> <a href="${ctx}/login/organizer">比赛组织者登录</a></span>
</div>
