                                ...
                                <table class="table" style="margin-bottom: 0;">
                                    ...
                                    <c:forEach items="${competitions}" var="competition" varStatus="index">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="${ctx}/organizer/applyInfo?id=${competition.id}" class="btn btn-dark btn-sm">报名状态</a>
                                                <a href="${ctx}/organizer/create?id=${competition.id}" class="btn btn-info btn-sm">修改</a>
