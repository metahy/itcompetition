                            ...
                            <div class="card-body">
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <form action="${ctx}/organizer/uploadData" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="role" value="organizer">
                                            <input type="hidden" name="id" value="${competition.id}">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">资料</label>
                                                <input id="cc-payment" name="refFile" multiple type="file" class="form-control">
                                            </div>
                                            <div>
                                                <span style="color: red; font-size: 13px;">上传新资料将遗弃之前上传的资料，请谨慎</span>
